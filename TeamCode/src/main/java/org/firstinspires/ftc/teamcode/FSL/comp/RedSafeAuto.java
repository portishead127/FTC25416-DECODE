...
public class RedSafeAuto extends OpMode {
    ...
    @Override
    public void init() {
        robot = new Robot(hardwareMap, telemetry, false, false, false, follower);
    ...
    public static class Paths {
        ...
        public PathChain IntakeOfMiddleRow;
        public PathChain TipOfTriangle2;
        public PathChain InfrontOfHighRow;
        public PathChain IntakeOfHighRow;
        ...
        public Paths(Follower follower) {
            ...
            IntakeOfMiddleRow = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(88.000, 60.000),
            ...
            IntakeOfHighRow = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(88.000, 84.000),
